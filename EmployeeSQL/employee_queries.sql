...
COPY departments from '/Users/stacy/departments.csv'
with (format CSV, HEADER);

COPY employees from '/Users/stacy/employees.csv'
with (format CSV, HEADER);

COPY department_employees from '/Users/stacy/dept_emp.csv'
with (format CSV, HEADER);

COPY department_manager from '/Users/stacy/dept_manager.csv'
with (format CSV, HEADER);

COPY titles from '/Users/stacy/titles.csv'
with (format CSV, HEADER);

COPY salaries from '/Users/stacy/salaries.csv'
with (format CSV, HEADER);
...
/* It seems as though the department_employee table isn't updated when a manager leaves the company,
but the department_manager table is, so the 'to_date' listed here reflects what is in the department_manager table. */
